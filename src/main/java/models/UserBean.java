...
import jmx.PointStatistics;
import jmx.HitsPercentage;
...
public class UserBean implements Serializable {
    ...
    private final HitsPercentage hitsPercentage;
    private final PointStatistics pointStatisticsMBean;
    @Inject
    ...
    public UserBean(){
        hitsPercentage = new HitsPercentage(requests, clickCounter);
        pointStatisticsMBean = new PointStatistics(requests);
        try {
            JMXMonitor.configure(hitsPercentage, pointStatisticsMBean);
...
//            return "error?faces-redirect=true";
    ...
    public void addPoint(Point point) {
        hitsPercentage.updatePoints(requests, clickCounter);
        hitsPercentage.getPercentage();
